...
sql="select * from AL_032_Finsh_Goods"
...
winObject = window.open("Lot_Search.asp", "test9", settings);
    ...
    <tr>
        <td width="120"  bgcolor="#CCFFCC" style="text-align:center; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
                <b>납품 수량</b></td>
         <td width="221" style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:5px;">
                 <input type="text" name="Delivery_Amount"  maxlength="12" style="width:90%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;"></td>
	   ...
	   <td rowspan=8 width="120"  bgcolor="#CCFFCC" style="text-align:center; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
        ...
        <div style="line-height:250%;">
          1. <input type="text" name="Lot_number_01" maxlength="30" style="width:80%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>2. <input type="text" name="Lot_number_02" maxlength="30" style="width:80%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>3. <input type="text" name="Lot_number_03" maxlength="30" style="width:80%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>4. <input type="text" name="Lot_number_04" maxlength="30" style="width:80%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>5. <input type="text" name="Lot_number_05" maxlength="30" style="width:80%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>6. <input type="text" name="Lot_number_06" maxlength="30" style="width:80%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>7. <input type="text" name="Lot_number_07" maxlength="30" style="width:80%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>8. <input type="text" name="Lot_number_08" maxlength="30" style="width:80%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      </div></td>
	 ...
	 <td rowspan=8 width="120" bgcolor="#CCFFCC" style="text-align:center; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
	  ...
	  <td rowspan=8 width="222" style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:5px;">
       <div style="line-height:250%;">
          1. <input type="text" name="Expiration_Date_01" maxlength="30" style="width:80%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>2. <input type="text" name="Expiration_Date_02" maxlength="30" style="width:80%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>3. <input type="text" name="Expiration_Date_03" maxlength="30" style="width:80%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>4. <input type="text" name="Expiration_Date_04" maxlength="30" style="width:80%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>5. <input type="text" name="Expiration_Date_05" maxlength="30" style="width:80%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>6. <input type="text" name="Expiration_Date_06" maxlength="30" style="width:80%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>7. <input type="text" name="Expiration_Date_07" maxlength="30" style="width:80%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>8. <input type="text" name="Expiration_Date_08" maxlength="30" style="width:80%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      </div></td>
	</tr>
	 ...
	 <td  bgcolor="#CCFFCC" style="text-align:center; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
	  ...
	  <td style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:5px;">
        <select name="COA_Obtain"><option></option>
                                     ...
                                     <option value="기입수">기입수</option></select></span></td>
