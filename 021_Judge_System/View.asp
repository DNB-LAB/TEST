  ...
  <table border=0 cellspacing=0 cellpadding=0 width="1024" align=center  style="table-layout:fixed;"> 
    <tr> 
      ...
      <b>▶ 선택 완제품(화장품) 세부 정보</b></td>
          ...
          <td width="512"  bgcolor="D7F1FA"  style="text-align:right; text-indent:0; margin:0; padding-top:8px; padding-right:0px; padding-bottom:8px; padding-left:0px;">
...
<tr> 
  ...
  <table border=0 cellspacing=0 cellpadding=0 width="1024" align=center  style="table-layout:fixed;">
     <tr> 
      <td width="512"  bgcolor="#D7F1FA" style="text-align:left; text-indent:0; margin:0; padding-top:15px; padding-right:0px; padding-bottom:8px; padding-left:0px;">
      <b>▶ 완제품 납품 정보&nbsp;&nbsp;&nbsp;&nbsp;등록자: <%=Registor_name%> </b></td>
      <td width="512"  bgcolor="#D7F1FA" style="text-align:right; text-indent:0; margin:0; padding-top:15px; padding-right:0px; padding-bottom:8px; padding-left:0px;">
         <a href="javascript:history.go(-1)"><img src="images/back.gif"  border="0"></a>&nbsp;
             <a href="list.asp?<%=Var3%>"><img src=images/list.gif border=0></a></td>
    </tr>
</table>
    ...
    <tr>
	 ...
	 <td rowspan=7 width="120" bgcolor="#CCFFCC" style="text-align:center; text-indent:0; margin:0; padding-top:8px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
         <b>사용기한</b></font></td>
	  <td rowspan=7 width="222" style="text-align:left; text-indent:0; margin:0; padding-top:8px; padding-right:0px; padding-bottom:5px; padding-left:5px;">
  ...
  <table border=0 cellspacing=0 cellpadding=0 width="1024" align=center  style="table-layout:fixed;">
        <tr>
         <td bgcolor="#D7F1FA" style="text-align:left; text-indent:0; margin:0; padding-top:8px; padding-right:0px; padding-bottom:8px; padding-left:0px;">
         ...
         최종 수정일:&nbsp;<%=mid(UTime,6)%></td>
           ...
           <tr>
         <td colspan=2 bgcolor="#D7F1FA" style="text-align:center; text-indent:0; margin:0; padding-top:8px; padding-right:0px; padding-bottom:8px; padding-left:5px;">
          <a href="update.asp?<%=Var3%>"><img src="images/edit.gif"  border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
          <a href="delete.asp?<%=Var3%>"><img src="images/del.gif" border="0"></a></td>
         </tr>
          </table>
...
'한꺼번에 모두 가져와서 변수에 대입
  ...
  W_Remarks = replace (W_Remarks,"&","&amp;")
  W_Remarks = replace (W_Remarks,"<","&lt;")
  W_Remarks = replace (W_Remarks,">","&gt;")
  W_Remarks = replace (W_Remarks,Chr(32),"&nbsp;") '공백(스페이스)
  W_Remarks = replace (W_Remarks,Chr(13),"<br>") '줄바꿈
...
%>
      ...
      <table border=0 cellspacing=0 cellpadding=0 width="1024" align=center  style="table-layout:fixed;">
       <tr>
       <td  bgcolor="#D7F1FA" style="text-align:left; text-indent:0; margin:0; padding-top:15px; padding-right:0px; padding-bottom:8px; padding-left:0px;">
        <b>☞ 물류 샘플링 검사 결과&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b>
         검사 일: <b><%=W_Sdate%></b></td> 
       <td  bgcolor="#D7F1FA" style="text-align:right; text-indent:0; margin:0; padding-top:15px; padding-right:0px; padding-bottom:8px; padding-left:0px;">
        <a href="javascript:history.go(-1)"><img src=images/back.gif border=0></a>&nbsp;
             <a href="list.asp?<%=Var3%>"><img src=images/list.gif border=0></a></td>
    </tr>
  </table>  
<table border=1 cellspacing=0 cellpadding=0 width="1024" align=center  style="table-layout:fixed;">
   ...
   <td width="120"bgcolor="#F0B6B6" style="text-align:center; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
     ...
     <td width="120" bgcolor="#F0B6B6" style="text-align:center; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
      ...
      <b>비 &nbsp;&nbsp;고</b></td>
              <td colspan=5 style="text-align:left; text-indent:0; margin:0; padding-top:7px; padding-right:0px; padding-bottom:5px; padding-left:5px;">
              <%=W_Remarks%>&nbsp;</td>
        </tr>
        <% if Sfile1 <>"" then%>
       <tr> 
    <td   bgcolor="#F0B6B6" style="text-align:center; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
      <b>첨&nbsp;&nbsp;&nbsp;&nbsp;부 1</td>
       <td colspan=5 bgcolor="#FFFFFF" style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:10px;">
          <a href="Warehouse/Upload_01/<%=sFile1%>" target="_blank"><b> <u><%=sfile1%></u> </b></a></td>             
           </tr>
              <% else %><% end if%>
     ...
     <tr> 
      ...
      <b>첨&nbsp;&nbsp;&nbsp;&nbsp;부 2</td>
       <td colspan=5 bgcolor="#FFFFFF" style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:10px;">
        <a href="Warehouse/Upload_02/<%=sFile2%>" target="_blank"><b> <u><%=sfile2%></u> </b></a></td>     
    </tr>
     <% else %><% end if%>
    ...
    <tr> 
     <td   bgcolor="#F0B6B6" style="text-align:center; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
       <b>첨&nbsp;&nbsp;&nbsp;&nbsp;부 3</td>
       <td colspan=5 bgcolor="#FFFFFF" style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:10px;">
       <a href="Warehouse/Upload_03/<%=sFile3%>" target="_blank"><b> <u><%=sfile3%></u> </b></a></td>     
    </tr>
     <% else %><% end if%>
      </table>  
    <table border=0 cellspacing=0 cellpadding=0 width="1024" align=center  style="table-layout:fixed;">
        ...
        <td bgcolor="#D7F1FA" style="text-align:left; text-indent:0; margin:0; padding-top:8px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
           최초 등록일:&nbsp;<%=mid(W_Stime,6)%></td>
           <td bgcolor="#D7F1FA" style="text-align:right; text-indent:0; margin:0; padding-top:8px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
         최종 수정일:&nbsp;<%=mid(W_Utime,6)%></td>
       
          <tr>
         <td colspan=2 bgcolor="#D7F1FA" style="text-align:center; text-indent:0; margin:0; padding-top:8px; padding-right:0px; padding-bottom:5px; padding-left:5px;">
           <a href="Warehouse/Warehouse_update.asp?<%=Var3%>&original_sid=<%=original_sid%>">
             <img src="images/edit.gif"  border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
             <a href="Warehouse/Warehouse_Delete.asp?<%=Var3%>&original_sid=<%=original_sid%>">
