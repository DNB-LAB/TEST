...
<html>
<head>
<title>1. 시장출하 적부 판정 기록 자료 기간별 조회</title>
...
<body bgcolor="#D7F1FA">
    <table border="1" width="800" align="center" cellspacing="0">
        <form method=get action="01_P_Code_ok.asp?<%=Var5%>"  name="form" onSubmit="Check();return true;">
        <tr height="30">
            <td width="600"  bgcolor="#B3CCF4" align="center">
          <font face="돋움"><b>1.  시장출하 적부 판정 기록 기간별 조회 [ 제품코드]</td>
...
입고일 : <select name="Styear" id="Styear" style="width:70">
	...
	<br><br style=line-height:5px;><b>제품코드 : <input type="text" size=20 name="Product_Code"></center>
</td>
