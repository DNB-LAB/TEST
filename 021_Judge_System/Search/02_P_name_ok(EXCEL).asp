...
<tr>
       <td width="1080" colspan=12 align=Center>
       <span style="font-size:12pt;"><b>2. 시장출하 적부 판정 기록 기간별 조회 결과[제품명]</td>
    </tr>
...
<table style="border-collapse:collapse;" align="center" cellspacing="0" width="1080">
   <tr>
       <td  colspan=8  align=left><b>입고일로 <%=mid(Stdate,3)%>부터 <%=mid(Fdate,3)%>까지</b>&nbsp;&nbsp;&nbsp;&nbsp;
<% if Product_Name_DZ="" then %>
          제품명으로 <b>[]</font></b>을(를) 검색한 결과
<% elseif Product_Name_DZ <> "" then %>          
          <b>제품명으로  <b>[ <%=Product_Name_DZ%> ]</font></b>을(를) 검색한 결과</span>
...
<table border=1 cellspacing="0" cellpadding="0" width="1080" align="center" bgcolor="#ffffff"  style='table-layout:fixed;'>
       ...
       <tr height="42">
        ...
        <td align="center" width="250" bgcolor="#CCCCCC"><b>제 품 명</b></td>
        ...
        <td align="center" width="170"  bgcolor="#CCCCCC"><b>입고처<br>출고처</b></td>
