...
<html>
<head>
<title>1. 시장출하 적부 판정 기록 기간별 조회 결과[코드별]</title>
...
<tr>
       ...
       <span style="font-size:12pt;"><b>1. 시장출하 적부 판정 기록 기간별 조회 결과[코드별]</td>
    </tr>
...
<% if Product_Code="" then %>
          제품코드로는 <b><font color=red>[]</font></b>을(를) 검색한 결과
<% elseif Product_Code <> "" then %>          
          <b>제품코드로는 [ <%=Product_Code%> ]</font></b>을(를) 검색한 결과</span>
