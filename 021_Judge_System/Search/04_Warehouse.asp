...
<body bgcolor="#D7F1FA">
    <table border="1" width="800" align="center" cellspacing="0">
        <form method=get action="04_Warehouse_Ok.asp?<%=Var5%>"  name="form" onSubmit="Check();return true;">
        <tr height="30">
            <td width="600"  bgcolor="#EBFFEB" align="center">
          <font face="돋움"><b>4. 시장출하 적부 판정 기록 기간별 조회 [입고처]</td>
...
입고일 : <select name="Styear" id="Styear" style="width:70">
	...
	<br><br style=line-height:5px;><b>입고처 : <input type="text" size=20 name="Warehouse"></center>
</td>
