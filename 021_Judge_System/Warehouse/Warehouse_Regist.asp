...
<body bgcolor="#D7F1FA">
<center>
  <table border="0"  width="1024"  align=center cellpadding="0" cellspacing="0" style='table-layout:fixed;'>
    <tr> 
 ...
 <table border="1"  width="1024"  align=center  cellpadding="0" cellspacing="0" style='table-layout:fixed;'>
...
<tr> 
  ...
  <table width="1024" border="0" align=center  cellpadding="0" cellspacing="0" style="table-layout:fixed;">
          <tr height="30"> 
            <td width=512  bgcolor="#D7F1FA"  align=left>최초 등록 : <%=Stime%></td>
            <td width=512  bgcolor="#D7F1FA" align=right>최종 수정 : <%=Utime%></td>
          </tr>
        </table>
...
//  -->
         ...
         <form method="post" action="Warehouse_Regist_Ok.asp?Original_sid=<%=sid%>" name="form" onSubmit="return Send()" enctype="multipart/form-data">
 ...
 <table border=1 cellspacing=0 cellpadding=0 width="1024" align=center  style="table-layout:fixed;">
     ...
     <td  width=120 bgcolor="#F0B6B6" style="text-align:center; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
      <b>검사 방법</td>
           <td width=221 style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:10px;">      
            <select name="W_Judge_Method"><option></option>
                                     <option value="파괴">파괴</option>
                                     <option value="비파괴">비파괴</option>
      ...
      <b>검사 결과</td>
           <td width=221 style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:10px;">      
            <select name="W_Judge_Result"><option></option>
       ...
       <td  width=120 bgcolor="#F0B6B6" style="text-align:center; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
      <b>등록자</td>
      <td width="" style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:10px;">      
          <%=session("mname")%></td>
     ...
     <td   bgcolor="#F0B6B6" style="text-align:center; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
       ...
       <td colspan=5 bgcolor="#FFFFFF" style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:10px;">
         <textarea  name="W_Remarks" style="width:95%;height:100;border:1;overflow:visible;text-overflow:ellipsis;" rows="5" ></textarea></td>
    </tr>
      ...
      <b>첨&nbsp;&nbsp;&nbsp;&nbsp;부 1</td>
       <td colspan=5 bgcolor="#FFFFFF" style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:10px;">
        <input type="file" name="Sfile1" style="width:96%;height:100;border:1;overflow:visible;text-overflow:ellipsis;"> 
              <br><br style="line-height:5px;"><b>※ 첨부파일 크기는 최대 <font color=red><%=maxsize%> MB</font>입니다.  
              더  큰 파일은 서버 부하를 줄이기 위하여 업로드가 안됩니다.</b></td>
    </tr>
    <tr> 
      <td   bgcolor="#F0B6B6" style="text-align:center; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
      <b>첨&nbsp;&nbsp;&nbsp;&nbsp;부 2</td>
    ...
    <tr> 
     ...
     <td   bgcolor="#F0B6B6" style="text-align:center; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
       <b>암&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;호</td>
       <td colspan=5  bgcolor="#FFFFFF" style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:10px;">
         <input type="password" name="Pass" size="10" maxlength=10> <b><font color=red>※ 수정,혹은 삭제시에 필요합니다.</td>
    </tr>
    
   </table>
  <table cellspacing=0 align="center" cellpadding=0 border="0"  width="1024" cellpadding="0" cellspacing="1" style="word-wrap:break-word;word-break:break-all;">
    <tr height=60> 
