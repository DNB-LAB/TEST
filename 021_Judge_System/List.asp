...
<%
if session("id")="" or session("Aceess_02")="N" then  
'로그인하여 얻은 세션(id)가 없으면 로그인으로 돌려 보내고 있으면 리스트를 보여준다.
%>

<body leftmargin="0" topmargin="0" bgcolor="#FAE0D4">
<script language="javascript">
	alert("현재 페이지를 조회할 권한있는 아이디로 로그인 하세요. \n\n\로그인했더라도 오래되어 자동 로그 아웃 되었습니다. \n\n\재 로그인하던지 조회 권한있는 페이지로 이동하세요 !");
...
%>
      ...
      <table cellspacing=0 cellpadding=2 border=0 width="1024"  align=center  style='table-layout:fixed;'>
        ...
        <table cellspacing=0 width="1024" cellpadding="1" align=center bgcolor=#FFFFFF align=center  style='table-layout:fixed;'>
          <!---게시판 각열의 이름 출력--->
          <tr  height=2> 
     ...
     <div style="line-height:150%;"> 
      ...
      <td width="150"  bgcolor="#CCFFCC"  align="center"><b>제조사<br>입고처</td>
      <td width="50"  bgcolor="#CCFFCC"  align="center"><b>성적서</td>
      <td width="35"  bgcolor="#CCFFCC"><b>조회</td>
      <td width="75"  bgcolor="#CCFFCC"><b>입고일<br>등록일</td>
    </tr>
    <tr  height=1> 
              ...
              <td align="right">
               <input  type="hidden" name="Table" value="<%=Stable%>">
                <select name="Field" style="width:110">
                  ...
                  <input type="text" name="Str" value="<%=Str%>" size="50">
                  <input  type="submit" value="검색"> 
                  <% if str<>"" then %>
                 <input  type="button" onClick="document.location.href='list.asp?Table=<%=Stable%>'" value="취소">
                <%end if%></td>
              <td align="right" width="270"><a href="Search/Search_condition.asp"><img src="images/inquiry.gif"  border="0"></a></td>
