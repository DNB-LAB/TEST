...
SQL = "SELECT top 1 * FROM AL_021_Judge_System where Sid=" & Sid
...
//  -->
   ...
   <form name="form" method="post" action="update_ok.asp?sid=<%=sid%>" onSubmit="return Send()" enctype="multipart/form-data">
...
<table cellspacing=0 cellpadding=0 border="0"  width="1024" cellpadding="0" cellspacing="1" style="word-wrap:break-word;word-break:break-all;">
    <tr> 
      ...
      <b>▶ 선택 완제품(화장품) 세부 정보 </b></td>
          ...
          <td width="512" align=right bgcolor="D7F1FA">
 ...
 <table cellspacing=0 cellpadding=0 border="1"  width="1024" cellpadding="0" cellspacing="1" style="word-wrap:break-word;word-break:break-all;">
  ...
  <table cellspacing=0 cellpadding=0 border="1"  width="1024" cellpadding="0" cellspacing="1" style="word-wrap:break-word;word-break:break-all;">
    ...
    <tr> 
      ...
      <b>▶ 완제품 납품 정보&nbsp;&nbsp;&nbsp;&nbsp;등록자: <%=Registor_name%> </b></td>
...
winObject = window.open("Lot_Search.asp", "test9", settings);
    ...
    <tr>
        <td width="120"  bgcolor="#CCFFCC" style="text-align:center; text-indent:0; margin:0; padding-top:8px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
                <b>납품 수량</b></td>
         <td width="221" style="text-align:left; text-indent:0; margin:0; padding-top:8px; padding-right:0px; padding-bottom:5px; padding-left:5px;">
                  <input type="text" name="Delivery_Amount" maxlength="12" value="<%=Delivery_Amount%>" style="width:90%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;"></td>
	
	   <td rowspan=8 width="120"  bgcolor="#CCFFCC" style="text-align:center; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
         <b>Lot No</b></td>
       
        <td rowspan=8  width="221" style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:5px;">
           <div style="line-height:250%;">
          1. <input type="text" name="Lot_number_01"   value="<%=Lot_number_01%>"  style="width:90%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>2. <input type="text" name="Lot_number_02"   value="<%=Lot_number_02%>"  style="width:90%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>3. <input type="text" name="Lot_number_03"   value="<%=Lot_number_03%>"  style="width:90%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>4. <input type="text" name="Lot_number_04"   value="<%=Lot_number_04%>"  style="width:90%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>5. <input type="text" name="Lot_number_05"   value="<%=Lot_number_05%>"  style="width:90%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>6. <input type="text" name="Lot_number_06"   value="<%=Lot_number_06%>"  style="width:90%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>7. <input type="text" name="Lot_number_07"   value="<%=Lot_number_07%>"  style="width:90%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>8. <input type="text" name="Lot_number_08"   value="<%=Lot_number_08%>"  style="width:90%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      </div></td>
      
	 <td rowspan=8 width="120" bgcolor="#CCFFCC" style="text-align:center; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
         <b>사용기한</b></font></td>
	  <td rowspan=8 width="222" style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:5px;">
      <div style="line-height:250%;">
          1. <input type="text" name="Expiration_Date_01"  value="<%=Expiration_Date_01%>"  style="width:90%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>2. <input type="text" name="Expiration_Date_02"  value="<%=Expiration_Date_02%>"  style="width:90%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>3. <input type="text" name="Expiration_Date_03"  value="<%=Expiration_Date_03%>"  style="width:90%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>4. <input type="text" name="Expiration_Date_04"  value="<%=Expiration_Date_04%>"  style="width:90%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>5. <input type="text" name="Expiration_Date_05"  value="<%=Expiration_Date_05%>"  style="width:90%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>6. <input type="text" name="Expiration_Date_06"  value="<%=Expiration_Date_06%>"  style="width:90%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>7. <input type="text" name="Expiration_Date_07"  value="<%=Expiration_Date_07%>"  style="width:90%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      <br>8. <input type="text" name="Expiration_Date_08"  value="<%=Expiration_Date_08%>"  style="width:90%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
      </div></td>
	</tr>
	
	  <tr>
        
	 <td  bgcolor="#CCFFCC" style="text-align:center; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
          <b>수량 Lot 구분</b></td>
        <td   style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:5px;">
                   <select name="Lot_No_Divide">
                                     <option value="구분됨" <%if Lot_No_Divide="구분됨" then%>selected<% end if%>>구분됨</option>
                                     <option value="구분안됨" <%if Lot_No_Divide="구분안됨" then%>selected<% end if%>>구분안됨</option></select></td>
	 ...
	 <td  bgcolor="#CCFFCC" style="text-align:center; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
        <b>제품 종류</b></td>
        <td style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:5px;">
                   <select name="Good_class">
                   <option value="화장품" <%if Good_class="화장품" then%>selected<% end if%>>화장품</option>
                   <option value="화장품이외" <%if Good_class="화장품이외" then%>selected<% end if%>>화장품이외</option></select></td>
	 ...
	 <td  bgcolor="#CCFFCC" style="text-align:center; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
        ...
        <td   style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:5px;">
                   <select name="Judge_Result">
                                     <option value="적합" <%if Judge_Result="적합" then%>selected<% end if%>>적합</option>
                                     <option value="부적합" <%if Judge_Result="부적합" then%>selected<% end if%>>부적합</option>
                                     <option value="보류" <%if Judge_Result="보류" then%>selected<% end if%>>보류</option>
                                     <option value="기입고" <%if Judge_Result="기입고" then%>selected<% end if%>>기입고</option></select></td>
	  ...
	  <tr>
	   <td bgcolor="#CCFFCC" style="text-align:center; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
         <b>제조사</b></font></td>
	  <td style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:5px;">
      <input type="text" name="Supplier"  maxlength="40" value="<%=Supplier%>" style="width:90%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;"></td>
		</tr>
		<tr>
	   <td bgcolor="#CCFFCC" style="text-align:center; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
         <b>입고처</b></font></td>
	  <td style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:5px;">
      <input type="text" name="Warehouse"  maxlength="40"  value="<%=Warehouse%>" style="width:90%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;"></td>
		</tr>
		<tr>
	   <td bgcolor="#CCFFCC" style="text-align:center; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
         <b>관리번호</b></font></td>
	  <td style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:5px;">
      <input type="text" name="Manage_No"  maxlength="20" value="<%=Manage_No%>" style="width:90%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;"></td>
		</tr>
		<tr>
	   <td bgcolor="#CCFFCC" style="text-align:center; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
         <b>성적서 입수</b></font></td>
	  <td style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:5px;">
      <select name="COA_Obtain"><option value="" <%if COA_Obtain="" then%>selected<% end if%>></option>
                                     <option value="입수" <%if COA_Obtain="입수" then%>selected<% end if%>>입수</option>
                                     <option value="미입수" <%if COA_Obtain="미입수" then%>selected<% end if%>>미입수</option>
                                     <option value="기입수" <%if COA_Obtain="기입수" then%>selected<% end if%>>기입수</option></td>
	...
	<tr>
	  ...
	  <td style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:5px;">
       <select name="Warehouse_Year" id="Warehouse_Year" style="width:70">
                ...
                <option value="<%=k%>"  <%if k=year(Warehouse_Date) then%> selected <% end if %>><%=k%>년</option>
								<% next%>							
            </select>
              <select name="Warehouse_Month" id="Warehouse_Month"  style="width:55">
							  <% for k=1 to 12 %>
                <option value="<%=k%>"  <%if k=month(Warehouse_Date) then%> selected <% end if %>><%=k%>월</option>
								<% next%>
              </select>
              <select name="Warehouse_Day" id="Warehouse_Day"  style="width:55">
							  <% for k=1 to 31 %>
                <option value="<%=k%>"  <%if k=day(Warehouse_Date) then%> selected <% end if %>><%=k%>일</option>
								<% next%> </select></td>                            
	
       <td rowspan=2 bgcolor="#CCFFCC" style="text-align:center; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
            <b>비&nbsp;&nbsp;&nbsp;&nbsp;고</b></td>
              <td rowspan=2 colspan=3 style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:5px;">
     <textarea   name="Remarks"  style="width:98%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;" rows="4"><%=Remarks%></textarea></td>
	
		</tr>
      <tr> 
           <td align="center"   bgcolor="#CCFFCC" ><b>암&nbsp;&nbsp;&nbsp;&nbsp;호</b></td>
             <td  style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:5px;">
  <input type="password" name="Pass" size="6" maxlength="10">&nbsp;<b>※등록시 입력한 암호 </b>
                    <br>
                  &nbsp;&nbsp;&nbsp;<% if session("mname")= Registor_name or  session("id")= bluehe then %>
                   <font color=red><b><%=Pass%></b>&nbsp;← 작성자 로그인시 보임<% else %> <font color=red>**&nbsp;&nbsp;← 작성자 로그인시 보임</font>
                   <% end if%></td>
      ...
      <tr> 
       <td bgcolor="#CCFFCC" style="text-align:center; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
         <b>첨부 파일1</b></td>
       <td colspan=5 style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:5px;">
         <input type="file" name="sfile1" style="width:98%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
         <br><br style="line-height:5pt;"> 
                &nbsp;기존 첨부파일 : 
                <% if sfile1<>"" then %>
                <font color=blue><%=sfile1%>
                <font color=blue> &nbsp;&nbsp;<b><font color=red>
                [ <a href="delete.asp?<%=Var3%>&file_mode=file1"><b><font color=red> 삭제</a> ] </font>
                <% else %>
                <strong>없음!</strong> 
                <% end if%></font></b>
              </td></td>
       ...
       <td bgcolor="#CCFFCC" style="text-align:center; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
         <b>첨부 파일2</b></td>
       <td colspan=5 style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:5px;">
         <input type="file" name="sfile2" style="width:98%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
             <br><br style="line-height:5pt;"> 
                &nbsp;기존 첨부파일 : 
                <% if sfile2<>"" then %>
                <font color=blue><%=sfile2%><font color=blue> &nbsp;&nbsp;<b><font color=red>
                [ <a href="delete.asp?<%=Var3%>&file_mode=file2"><b><font color=red>삭제</a> ] </font>
                <% else %>
                <strong>없음!</strong> 
                <% end if%></font></b>
              </td>
       ...
       <td bgcolor="#CCFFCC" style="text-align:center; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:0px;">
         <b>첨부 파일3</b></td>
       <td colspan=5 style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:0px; padding-bottom:5px; padding-left:5px;">
         <input type="file" name="sfile3" style="width:98%;height:100%;solid:1px;overflow:visible;text-overflow:ellipsis;">
             <br><br style="line-height:5pt;"> 
                &nbsp;기존 첨부파일 : 
                <% if sfile3<>"" then %>
                <font color=blue><%=sfile3%><font color=blue> &nbsp;&nbsp;<b><font color=red>
                [ <a href="delete.asp?<%=Var3%>&file_mode=file3"><b><font color=red>삭제</a> ] </font>
                <% else %>
                <strong>없음!</strong> 
                <% end if%></font></b>
              </td>
              ...
              <table cellspacing=0 cellpadding=2 border="0" width="1024" align=center>
       <tr height=80> 
            <td  align="center"  bgcolor="#D7F1FA"> 
          <input type="image" img src="images/edit.gif" border="0">&nbsp;&nbsp;&nbsp;
