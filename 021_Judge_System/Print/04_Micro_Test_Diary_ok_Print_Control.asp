...
<html>
<head>
<title>위탁 ODM 및 외주가공 제품/기타 미생물 시험일지 인쇄하기</title>
...
%> <tr>
      <td colspan=9 style="text-align:left; text-indent:0; margin:0; padding-top:5px; padding-right:3px; padding-bottom:3px; padding-left:5px;">            
      [ 결과 : (+) 미생물 양성 / (-) 미생물 음성] </td>
      </tr>
