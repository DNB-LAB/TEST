...
<body bgcolor="#D7F1FA">
    <table border="1" width="800" align="center" cellspacing="0">
        <form method=get action="04_Micro_Test_Diary_ok.asp?<%=Var5%>"  name="form" onSubmit="Check();return true;">
        <tr height="30">
            <td width="600"  bgcolor="#DCCA97" align="center">
          <font face="돋움"><b>위,수탁제품 및 외주가공 제품/기타 미생물 시험 일지 조회 및 출력</td>
            <td width="200" bgcolor="#DCCA97"  align="center">
...
<select name="Syear" id="Syear" style="width:80">
	...
	<% next%> </select>
                                  ...
                                  <select name="Microbial_judge">
                                    <option value="2">미생물</option></select></span></td>
