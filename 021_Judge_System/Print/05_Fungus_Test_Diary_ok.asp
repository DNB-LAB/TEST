...
<html>
<head>
<title>위탁 ODM 및 외주가공 제품/기타 진균 시험일지 조회</title>
...
<table style="border-collapse:collapse;" align="center" cellspacing="0" width="720">
    <tr>
       ...
       <a href="05_Fungus_Test_Diary_ok_Print.asp?Syear=<%=Syear%>&Smonth=<%=Smonth%>&Sday=<%=Sday%>&Microbial_judge=<%=Microbial_judge%>">
    ...
    <tr>
      ...
      <form method="post" action="05_Fungus_Test_Diary_ok_Print_Control.asp?sid=<%=Sid%>" name="form" OnSubmit="return Send()">
