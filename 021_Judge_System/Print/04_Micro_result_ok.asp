...
<table style="border-collapse:collapse;" align="center" cellspacing="0" width="720" height="93%">
    <tr>
      ...
      <tr height="40">
        ...
        <td align="center" width="190" bgcolor="#CCCCCC"><b><font color="black">제품코드 / ERP No.<br><br style="line-height:3pt;">제 품 명</font></b></td>
        <td align="center" width="80" bgcolor="#CCCCCC"><font color="black"><b>제조일<br><br style="line-height:3pt;">Lot No</b></font></td>
        <td align="center" width="90" bgcolor="#CCCCCC"><b><font color="black">사업부</font></b></td>
        <td align="center" width="60" bgcolor="#CCCCCC"><font color="black"><b>생산량<br><br style="line-height:3pt;">종류</b></font></td>
...
%> 
    <tr>
        ...
        <td align="center" width="" bgcolor="white"><%=formatnumber(Mf_amount,0)%> <%=Mf_unit%> <br><br style="line-height:3pt;"><% if good_class="위탁제품" then %>
        ODM
        <% else %>
