...
<html>
<head>
<title>수탁제품, 외주가공 미생물  시험결과 조회 및 인쇄</title>
...
-->
    ...
    <table border="1" width="800" align="center" cellspacing="0">
        <form method=get action="04_Micro_result_ok.asp?<%=Var5%>"  name="form" onSubmit="Check();return true;">
        <tr height="30">
            <td width="600"  bgcolor="#FFCC00" align="center">
          <font face="돋움"><b> 미생물 시험 판정 결과 등록일</td>
            <td width="200" height="25" bgcolor="#FFCC00" align="center">
