...
<link rel="stylesheet" href="basic_Finsh_Goods.css">
...
sql="select * from AL_032_Finsh_Goods where Product_Code LIKE '%" & Product_Code & "%'"
set RS=DB.execute(sql)

'응답형에 맞게 정렬한다

SQL = SQL & " ORDER BY Product_Code DESC,sid DESC"
...
<tr height="35"> 
<td align=left bgcolor="#D7F1FA">
<b> ☞ 완제품 Db(화장품)에서 완제품 코드로<font color="red"> <u>[ <%=Product_Code%> (을)를 ]</u> </font> 검색한 결과</b></td>
...
sql="select * from AL_034_Finsh_Goods_Other where Product_Code LIKE '%" & Product_Code & "%'"
set RS=DB.execute(sql)
...
%>
  ...
  <table cellspacing=1 width="1024" cellpadding="0" align=center style="table-layout:fixed;">
    <tr height=33> 
        ...
        <td align=left bgcolor="#D7F1FA"><b><font color="#0066FF">☞ <u>완제품 Db(기타) 에서
     
     완제품 코드로<font color="red"> <u>[ <%=Product_Code%> (을)를 ]</u> </font> 검색한 결과</b></td>
...
IF (RS.BOF and RS.EOF) Then
	Response.Write "<tr height=50> <td colspan=7 align=center>"
	Response.Write "완제품Db(기타) 검색 결과가 없습니다."
	Response.Write "</td></tr>"
